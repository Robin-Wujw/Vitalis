...
def test_skill_is_renderer_only_and_uses_intelligence_v3_contracts():
...
def test_skill_has_all_workflows_and_valid_schema():
    ...
    for name in (
        ...
        "training_responses.json", "personal_model.json", "timeline.json",
    ):
...
def test_skill_exposes_read_analyze_and_act_tools():
    expected = {
        ...
        "training_responses.py", "personal_model.py", "timeline.py",
